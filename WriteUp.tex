...
Model optimizers did not prove to have a significant effect on the performance of the model. The most successful optimizers were stochastic gradient descent (SGD) and Adam. Adam performed slightly better than SGD but the difference was marginal, no larger than 1 or 2 percent in general.

The final peak accuracy of the neural network was 95.66%.
